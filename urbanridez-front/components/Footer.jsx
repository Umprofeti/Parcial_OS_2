...
export default function Footer() {
  return (
    <>
    <div className='w-full h-auto sm:h-52 bg-zinc-900 grid grid-cols-1 sm:grid-cols-2 text-white px-8 border-t border-white pb-5'>
    ...
    <div className='w-full  bg-zinc-900 text-center border-t border-white'>
